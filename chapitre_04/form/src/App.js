		...
		return (
			<form onSubmit={this.handleSubmit}>
				<div class="form-group mb-3">
					...
					<input type="email" class="form-control" id="input-email" aria-describedby="emailHelp" placeholder="Enter email" onChange={this.handleChange}/>
				</div>

				<div class="form-group">
					<label class="mb-1" for="exampleInputPassword1">Password</label>
					<input type="password" class="form-control" id="exampleInputPassword1" placeholder="Enter password" onChange={this.handleChange} />
				</div>
		...
		return(
			<div class="row">
				<div class="col-4 mx-auto">
					...
					{ (!this.state.logged) ? this.renderForm() : this.renderForm() }
				</div>
			</div>
		)
	}
